...
import { Clock, Zap, ChevronRight, TrendingUp, Users, AlertCircle } from "lucide-react"
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center space-x-3">
              {isLive ? (
                ...
                <div className="px-2 py-1 rounded-full bg-secondary text-xs font-medium">{tournament}</div>
              )}
          ...
          <div className="grid grid-cols-7 gap-4 mb-6">
            <div className="col-span-3 text-center">
              <div className="relative w-16 h-16 mx-auto mb-3 team-logo">
                ...
                <div className="relative h-full w-full rounded-full bg-card border border-border flex items-center justify-center">
                  <Image
                    src={team1Logo || `/placeholder.svg?height=40&width=40&query=${team1}`}
                    alt={team1}
                    width={40}
                    height={40}
              ...
              {isLive && team1Score && <p className="text-sm text-muted-foreground mt-1">{team1Score}</p>}
            </div>

            <div className="col-span-1 flex flex-col items-center justify-center">
              <div className="text-xl font-bold text-muted-foreground">VS</div>
              {venue && <p className="text-xs text-muted-foreground text-center mt-1">{venue}</p>}
            </div>
            ...
            <div className="col-span-3 text-center">
              <div className="relative w-16 h-16 mx-auto mb-3 team-logo">
                ...
                <div className="relative h-full w-full rounded-full bg-card border border-border flex items-center justify-center">
                  <Image
                    src={team2Logo || `/placeholder.svg?height=40&width=40&query=${team2}`}
                    alt={team2}
                    width={40}
                    height={40}
                    className="object-contain"
              ...
              {isLive && team2Score && <p className="text-sm text-muted-foreground mt-1">{team2Score}</p>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <span className={`text-xl font-bold ${team1TextColorClass}`}>{team1Odds}</span>
            ...
            >
              <span className="text-sm text-muted-foreground">Back</span>
              <span className={`text-xl font-bold ${team2TextColorClass}`}>{team2Odds}</span>
            ...
            <div className="mt-4 pt-4 border-t border-border grid grid-cols-3 gap-4 animate-fade-in">
              <div className="flex flex-col items-center">
                ...
                <div className="w-full h-2 bg-secondary rounded-full overflow-hidden">
                  <div
                    className={`h-full ${team1Color === "blue" ? "bg-blue-500" : team1Color === "red" ? "bg-red-500" : team1Color === "yellow" ? "bg-yellow-500" : team1Color === "purple" ? "bg-purple-500" : "bg-primary"}`}
                    style={{ width: `${60}%` }}
                  ></div>
                </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-lg font-bold">{popularity || Math.floor(Math.random() * 100) + 1}%</div>
                <div className="text-xs text-muted-foreground">of users betting</div>
              </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              You are about to place a bet on {selectedTeam} with odds of {selectedOdds}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              />
              <div className="flex justify-between">
                <Button variant="outline" size="sm" onClick={() => setBetAmount("50")}>
                  $50
                </Button>
                <Button variant="outline" size="sm" onClick={() => setBetAmount("100")}>
                  $100
                </Button>
                <Button variant="outline" size="sm" onClick={() => setBetAmount("200")}>
                  $200
                </Button>
                <Button variant="outline" size="sm" onClick={() => setBetAmount("500")}>
                  $500
                </Button>
              </div>
            </div>
              ...
              <div className="bg-secondary/50 rounded-lg p-4 space-y-2">
                ...
                <div className="pt-2 border-t border-border flex justify-between font-medium">
                  ...
                  <span className="text-green-500">
                    ${betAmount ? (Number.parseFloat(betAmount) * Number.parseFloat(selectedOdds)).toFixed(2) : "0.00"}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button onClick={handlePlaceBet} className="glow-on-hover" disabled={isPlacingBet}>
              {isPlacingBet ? (
                <>
