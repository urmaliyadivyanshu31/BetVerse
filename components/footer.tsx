      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">BetVerse</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/matches" className="text-sm text-muted-foreground hover:text-primary">
                  Matches
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/ai-assistant" className="text-sm text-muted-foreground hover:text-primary">
                  AI Assistant
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} BetVerse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
